...
public class WebRequestCableCanal : CableCanalBehaviour, IContieneTextura
{
    ...
    Mat matSalida;
    public override Mat MatOut() => matSalida == null && texturaDescargada!=null ? matSalida = ManejoDeRecursos.Textura(texturaDescargada, matSalida) : matSalida;
...
#if UNITY_EDITOR
    [CustomEditor(typeof(WebRequestCableCanal))]
    public class WebRequestEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            DrawDefaultInspector();
            var webRequest = target as WebRequestCableCanal;
